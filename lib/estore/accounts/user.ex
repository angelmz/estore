defmodule Estore.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    belongs_to :role, Estore.Accounts.Role
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Estore.Repo)
  ...
  """
  def valid_password?(%Estore.Accounts.User{hashed_password: hashed_password}, password)
